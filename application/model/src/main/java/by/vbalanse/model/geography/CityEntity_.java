...
public class CityEntity_ extends AbstractManagedEntity_ {

    public static volatile SingularAttribute<CityEntity, String> title;
    public static volatile SingularAttribute<CityEntity, String> code;
