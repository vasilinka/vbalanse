...
package by.vbalanse.dao.storage.attachment;

import by.vbalanse.model.storage.attachment.AbstractAttachmentEntity;

import java.util.List;

public interface AttachmentDao extends by.vbalanse.dao.common.AbstractDao<AbstractAttachmentEntity,Long> {

  List<AbstractAttachmentEntity> findAttachmentsByGroup(long attachmentGroupId);
