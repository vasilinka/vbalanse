...
).run(function ($rootScope, $location, $cookieStore, Auth, UserService, $timeout, $cacheFactory, JsUtils/*, editableOptions*/) {
...
services.service("IconPopUpService", IconPopUpService);
module.directive("feedbackCarousel", feedbackCarousel);
...
module.directive("psy", psyDirective);
