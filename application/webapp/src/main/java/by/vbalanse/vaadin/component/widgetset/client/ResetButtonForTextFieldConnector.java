 ...
 */
import by.vbalanse.vaadin.component.ResetButtonForTextField;
  ...
  public native void addResetButtonClickListener(Element el)
    /*-{
      ...
      el.onclick = $entry(function() {
        self.@by.vbalanse.vaadin.component.widgetset.client.ResetButtonForTextFieldConnector::clearTextField()();
      });
    }-*/;
