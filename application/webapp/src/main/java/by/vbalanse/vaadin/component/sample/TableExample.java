...
//            columnformatting_component();
  ...
  void spreadsheet(VerticalLayout layout) {
    ...
    components.addComponent(new Label("Press" +
        "<ul>" +
    ...
    navigator.setContent(components);
  ...
  void editableHeights() {
    ...
    Object people[][] = {
        ...
        {new GregorianCalendar(1891, 0, 0).getTime(), "Finnish", "VГ¤isГ¤lГ¤"},
